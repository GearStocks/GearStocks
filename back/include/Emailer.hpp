...
public:
  Emailer();
  ~Emailer();
  int sendMailDependingOnType(std::string userMail, std::string password, std::string mailType);
private:
  int   sendMail(std::string userMail, std::string password, std::string mailType);
