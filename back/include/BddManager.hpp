...
public:
  ...
  size_t	addCarPartInBDD(std::string name, std::string month, std::string prices, std::string photo, std::string description, std::vector<std::string> categories, std::string brand, std::string model);
  ...
  std::vector<std::pair<std::string, std::vector<std::string>>>  parseCategoryNames();
  std::vector<std::string>  parseSubCategoriesFromCategory(std::string categoryName);
  std::vector<std::pair<std::string, std::vector<std::string>>> parseBrandAndModel();
  std::string getMaxPricePart();
